            ...
            <div class="card-body px-2 py-2">
                <div class="d-flex flex-nowrap align-items-center justify-content-start gap-3 overflow-auto">
                    ...
                    <div class="d-flex align-items-center nowrap-item">
                        ...
                        <input type="number" class="form-control total border-0 text-end" style="width: 70px;"
                    ...
                    @if ($discount === 1)
                        ...
                        <div class="d-flex align-items-center nowrap-item">
                            ...
                            <select name="sale_discount_type" class="form-select form-select-sm sale_discount_type"
                                style="width: 65px;">
                                <option value="fixed">৳</option>
                                <option value="percentage">%</option>
                            </select>
                            <input type="number" class="form-control form-control-sm handsOnDiscount text-end"
                                style="width: 60px;" name="" value="0" />
                        </div>
                    @endif
                    ...
                    @if ($tax == 1)
                        ...
                        <div class="d-flex align-items-center nowrap-item">
                            ...
                            <input type="text" class="form-control tax border-0 text-end" style="width: 70px;"
                    ...
                    <div class="d-flex align-items-center nowrap-item">
                        ...
                        <input type="number" class="form-control invoice_total border-0 text-end" style="width: 70px;"
                    ...
                    @if ($invoice_payment === 0)
                        ...
                        <div class="d-flex align-items-center nowrap-item">
                            ...
                            <input type="number" class="form-control previous_due border-0 text-end"
                                style="width: 70px;" name="previous_due" readonly value="0.00" />
                        </div>

                        <!-- Grand Total -->
                        <div class="d-flex align-items-center nowrap-item">
                            <span class="me-2">Grand Total:</span>
                            <input type="number" class="form-control grandTotal border-0 text-end" style="width: 70px;"
                    ...
                    <div class="d-flex align-items-center nowrap-item">
                        ...
                        <input class="form-control form-control-sm total_payable text-end"
                            style="width: 70px; border:1px solid #1761D1" minlength="0" name="total_payable"
                            type="number" value="" />
                    </div>
                    <div class="d-flex align-items-center nowrap-item">
                        ...
                        <input type="number" class="form-control total_due border-0 text-end" style="width: 70px;"
                            name="" readonly value="0.00" />
                    </div>
                    <!-- Transaction Method -->
                    <div class="d-flex align-items-center nowrap-item">
                        <span class="me-2">Method:</span>
                        <select class="form-select form-select-sm payment_method" style="width: 120px;"
                            data-width="100%">
                            @if ($payments->count() > 0)
                    ...
                    <div class="d-flex align-items-center gap-2 nowrap-item">
                        <button class="btn btn-sm btn-primary payment_btn"><i class="fa-solid fa-money-check-dollar"></i>
                            Pay</button>
                        <button class="btn btn-sm btn-secondary draft_invoice"><i class="fa-solid fa-file-lines"></i>
                            Draft</button>
                    </div>
                </div>
            </div>
    ...
    <div class="offcanvas">
        ...
        <form id="myValidForm" action="{{ route('sale.settings.update') }}" method="post"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="flex items-center space-x-2">
                    <input class="form-check-input rounded-full" type="checkbox"
                        {{ $mode->rate_kit == 1 ? 'checked' : '' }} name="rate_kit" id="flexSwitchRateKit">
