    ...
    <div class="row">
        <div class="col-md-12   grid-margin stretch-card filter_box">
            <div class="card">
                ...
                <div class="col-md-2">
                    <div   style="width: 100%!important;">
                        <select class="js-example-basic-single  sale_status" data-width="100%" style="width: 100%;"
                            name="" data-placeholder="Sale Status">
...
document.querySelector('#filter').addEventListener('click', function(e) {
    ...
    let sale_status = document.querySelector('.sale_status').value;
