...
@section('admin')
    ...
    <label for="offcanvas-toggle"
        style="position: fixed; font-size:20px; top: 59px; right: 20px; z-index: 1000; cursor: pointer;">
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                @php
                                    $affiliators = \App\Models\Affiliator::where('branch_id', Auth::user()->branch_id)
                                        ->whereNull('user_id')
                                        ->get();
                                    $saleCommisions = \App\Models\Affiliator::where(
                                        'branch_id',
                                        Auth::user()->branch_id,
                                    )
        ...
        <form id="myValidForm" action="{{ route('sale.settings.update') }}" method="post"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="col-sm-6">
                    <div class="mb-3 form-valid-groups">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" {{ $mode->rate_kit == 1 ? 'checked' : '' }}
                                name="rate_kit" role="switch" id="rateKitSwitch">
                ...
                <div class="col-sm-12 rate-kit-type-section"
                    ...
                    <div class="mb-3 form-valid-groups">
                        ...
                        <input type="radio" class="form-check-input" id="rate_kit_type_party" name="rate_kit_type"
                            value="party"
                            {{ !empty($mode->rate_kit_type) && $mode->rate_kit_type == 'party' ? 'checked' : '' }}
                            {{ $mode->rate_kit == 1 ? '' : 'disabled' }}>
                        <label for="rate_kit_type_party" style="padding-right: 10px; padding-left: 5px">Party</label>
                        <input type="radio" class="form-check-input" id="rate_kit_type_normal" name="rate_kit_type"
                            value="normal"
                            {{ !empty($mode->rate_kit_type) && $mode->rate_kit_type == 'normal' ? 'checked' : '' }}
                            {{ $mode->rate_kit == 1 ? '' : 'disabled' }}>
                        <label for="rate_kit_type_normal" style="padding-right: 10px; padding-left: 5px">Normal</label>
                    </div>
                </div>
            </div>
