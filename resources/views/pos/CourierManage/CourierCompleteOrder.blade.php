...
<div class="row">
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title text-info">Courier Complete Order List</h6>
                               ...
                               <td><a href="{{ route('sale.invoice',$courier->sale->id) }}">{{ $courier->sale->invoice_number ?? ''}}</td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button class="btn btn-sm btn-success complete" title="Change Status">
                                            <i class="fas fa-check-circle"></i> Finished Order
                                        </button>
